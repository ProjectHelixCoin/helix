...
#   c) node1 mines 32 blocks, so now node 0 has 60001hlix, node 1 has 4250hlix, node2 has none.
#   d) node0 sends 601 hlix to node2, in two transactions (301 hlix, then 300 hlix).
