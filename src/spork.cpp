...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_20_KERNEL_EXTRA_STAKING_CHECK) r = SPORK_20_KERNEL_EXTRA_STAKING_CHECK_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_20_KERNEL_EXTRA_STAKING_CHECK") return SPORK_20_KERNEL_EXTRA_STAKING_CHECK;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_20_KERNEL_EXTRA_STAKING_CHECK) return "SPORK_20_KERNEL_EXTRA_STAKING_CHECK";
