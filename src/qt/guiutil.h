...
/** Utility functions used by the Helix Qt UI.
 */
namespace GUIUtil
{
...
// Render Helix addresses in monospace font
...
// Parse "helix:" URI into recipient object, return true on successful parsing
