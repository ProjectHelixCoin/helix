 ...
 */
    ...
    typeWidget->addItem(tr("Received Hlix from zHlix"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zHlix"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zHlix));
